...
function submitOrder() {
	...
	{
		alert("about to submit order!");
		confirmMessage = "<spring:message code='medication.regimen.confirmMessage'/>";
		alertify.confirm('Create drug order!', confirmMessage , function(){ return true;  }, function(){ alertify.notify('You probably want to review order') });
		alert("after alerify alert!");
...
<div id="individualDrugOrderDiv" class="box${model.patientVariation}">
	...
	<!-- <h2><spring:message code="medication.regimen.addMedication" /></h2> -->
		<form id="form" name="addIndividualDrug" method="post" action="${pageContext.request.contextPath}/module/medicationlog/manageDrugOrder/addDrugOrder.form" onsubmit="return submitOrder()">
		...
		<legend  class="scheduler-border"><spring:message code="medication.regimen.drugSelectionHeading" /></legend>
    		...
    		<div class="row">
				...
				<div class="col-md-6">
					<input id="drugSuggestBox" name="drugName" class="capitalize" list="drugOptions" placeholder="Search Drug..." class="form-control" />
		...
		<legend  class="scheduler-border">Patient Prescription Details</legend>
			...
			<div class="row">
				...
				<div class="col-md-6">
					<input type="number" name="dose" id="dose" size="2" min="1" max="5000"/> 
					<select class="capitalize" name="doseUnit" id="doseUnit">
					<option class="capitalize" value="">Select option</option>
    		...
    		<div class="row">
				...
				<div class="col-md-6">
					<select class="capitalize" name="route" id="route">
						<option class="capitalize" value="">Select option</option>
    		...
    		<div class="row">
				...
				<div class="col-md-6">
					<textarea rows="2" cols="30" name="dosingInstructions" id="dosingInstructions" maxlength="250"></textarea>
			   	</div>
    		</div>
    		...
    		<div class="row">
				...
				<div class="col-md-6">
					<input type="number" name="duration" id="duration" size="2" min="1" max="99"/>
    		...
    		<div class="row">
				...
				<div class="col-md-6">
					<select class="capitalize" name="orderReason" id="orderReason">
							<option class="capitalize" value="">Select option</option>
